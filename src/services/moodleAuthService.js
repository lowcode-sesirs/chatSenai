...
export const decodeMoodleToken = (token) => {
  ...
  try {
    ...
    return {
      ...
      courseId: data.courseId || data.course_id || data.moodleCourseId || data.moodle_course_id || null,
      courseName: data.courseName || data.course_name || data.courseFullName || data.course_fullname || null,
      courseExternalId: data.courseExternalId || data.course_external_id || data.externalCourseId || data.external_course_id || data.shortname || null,
...
export const validateMoodleSession = async (moodleToken, origin = 'moodle', page = 'chat') => {
  ...
  try {
    ...
    return {
      ...
      courseId: user.courseId || user.course_id || user.moodleCourseId || user.moodle_course_id || null,
      courseName: user.courseName || user.course_name || user.courseFullName || user.course_fullname || null,
      courseExternalId: user.courseExternalId || user.course_external_id || user.externalCourseId || user.external_course_id || user.shortname || null,
...
export const storeMoodleUser = (userData) => {
  ...
  const normalizedUser = {
    ...
    courseId: userData.courseId || userData.course_id || userData.moodleCourseId || userData.moodle_course_id || null,
    courseName: userData.courseName || userData.course_name || userData.courseFullName || userData.course_fullname || null,
    courseExternalId: userData.courseExternalId || userData.course_external_id || userData.externalCourseId || userData.external_course_id || userData.shortname || null,
...
export const getMoodleUser = () => {
  const normalizeRuntimeUser = (runtimeUser) => {
    ...
    const normalizedUser = {
      ...
      courseId: runtimeUser.courseId || runtimeUser.course_id || runtimeUser.moodleCourseId || runtimeUser.moodle_course_id || null,
      courseName: runtimeUser.courseName || runtimeUser.course_name || runtimeUser.courseFullName || runtimeUser.course_fullname || null,
      courseExternalId: runtimeUser.courseExternalId || runtimeUser.course_external_id || runtimeUser.externalCourseId || runtimeUser.external_course_id || runtimeUser.shortname || null,
